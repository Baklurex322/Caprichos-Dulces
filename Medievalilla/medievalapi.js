...
const server = http.createServer((request, response) => {
    ...
    switch(request.method)
    {
        case "GET":
            ...
            response.end(JSON.stringify(objetoItems.arregloItems));
        break;
        case "POST":
            ...
            request.on("data", info => {
                ...
                objetoItems.arregloItems.push(objNewItem);

                fs.writeFileSync("./json/items.json", JSON.stringify(objetoItems)); //el fs.writeFileSync permite guardar de manera constamnte los datos ingresados, osea aun reiniciiando server y pagina deben de seguir ahi los datos
        ...
        case "PUT":
            ...
            request.on("end", info => {
                ...
                objetoItems.arregloItems[0] = objModItem;
        ...
        case "DELETE":
            ...
            request.on("data", info => {
                ...
                objetoItems.arregloItems.splice(objdel.id, 1); //aqui es la linea que borra, el .splice borra un punto especifico .splice(variable.id del elemento, cuantos elementos van a borrar)
...
server.listen(puerto, () => {
    console.log("Si we, ya se prendi&oacute; esta wea en http://localhost:" + puerto);
});
